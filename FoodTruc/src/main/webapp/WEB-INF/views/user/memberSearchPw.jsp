...
<body id="page-top" class="bg-light-gray index">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				<h2 class="section-heading">회원 비밀번호 찾기</h2>
				<div class="col-sm-3">&nbsp;</div>

				<div class="col-sm-6">
					<div class="form-top">
						<div class="form-top-right">
							비밀번호가 기억나지 않으세요?<br /> 관련사항 입력후 비밀번호를 확인하실 수 있습니다.
						</div>
						</br> </br>
					</div>
					<!--
							...
							<div class="panel panel-default">
								...
								<div id="collapse1" class="panel-collapse collapse in">
									<div class="panel-body">
											...
											<button class="btn btn-info" id="findPw">
	...
	<script>
		$("#findPw").click(function(){
			var regular  = /^[0-9]+$/;
			var regularE = /[0-9a-zA-Z][_0-9a-zA-Z-]*@[_0-9a-zA-Z-]+(\.[_0-9a-zA-Z-]+){1,2}$/;
			...
			if(!regularE.test($("#memberEmail").val())){
			...
			$.ajax({
				type : 'get',
				url : '../user/memberFindPwAction.do',
				data : {"memberId" : $("#memberId1").val(), "memberPhone" : $("#memberPhone").val(),
