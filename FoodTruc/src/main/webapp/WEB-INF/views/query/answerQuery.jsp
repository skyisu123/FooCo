	...
	<div class="container" style="margin-top: 150px;">
				<div class="row">
					...
					<div class="card-header" data-background-color="gray">
						<h3>
							<img src="../resources/bootstrap/img/about/email.png" style="width:40px; height:40px;"/>
							&nbsp;&nbsp;&nbsp;
							문의글 답변하기
						</h3>
					</div>
						<form action="answerQueryAction.do?queryNum=${list.queryNum }" class="form-horizontal"
							method="post" name="queryForm" enctype="multipart/form-data">
							<div class="form-group">
								<!-- 판매자 아이디는 세션에 저장되어있는 정보로 출력 -->
								<div class="form-group">
									<label class="col-sm-3 control-label" for="memberId">사용자 아이디</label>
									<div class="col-sm-3">
										<input class="form-control" name="memberId" id="memberId"
											value="${list.memberId}" readonly
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="sellerId">푸드트럭 아이디</label>
									<div class="col-sm-3">
										<input class="form-control" name="sellerId" id="sellerId"
											value="${list.sellerId}" readonly
											style="border-bottom:1px solid purple;
											font-weight:bold;"
											type="text">
									</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="queryType">문의 종류</label>
									<div class="col-sm-3">
										<input class="form-control" name="sellerId" id="sellerId"
											value="${list.queryType}"
											style="border-bottom:1px solid purple;
											font-weight:bold;"
											type="text">
									</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="queryTitle">문의 제목</label>
									<div class="col-sm-5">
										<input class="form-control" name="queryTitle" id="queryTitle"
											value="re : ${list.queryTitle}"
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="queryContent">문의 내용</label>
									<div class="col-sm-9">
...
=================</textarea>
								...
								<div class="form-group">
									<div class="col-sm-12" style="text-align:center;" >
										<input type="submit" class="btn btn-info" value="답변하기" />
									</div>
								</div>
