...
<section id="portfolio" class="bg-light-gray">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted"
					style="margin-bottom: 20px">Search Food Truck List.</h3>
			</div>
		</div>
		...
		<div class="row text-left" style="margin-bottom: 30px;">
			<div class="col-lg-12">
				<h2 style="text-transform:none; font-family:arial;">Search Food Truck List</h2>
				<h4>검색하신 푸드트럭 리스트입니다.</h4>  
		   	</div>
		</div>
		<!-- portpolio시작(list시작) -->
		...
		<div class="col-sm-12 text-center">
			<c:if test="${paging.currentPage ne paging.firstPageNo}">
				<a
					href="${urlPath}&currentPage=${paging.prevPageNo}"
			...
			<c:if test="${paging.currentPage ne paging.finalPageNo}">
				<a
					href="${urlPath}&currentPage=${paging.nextPageNo}"
