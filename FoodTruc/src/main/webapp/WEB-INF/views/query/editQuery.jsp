	...
	<div class="container" style="margin-top: 150px;">
				<div class="row">
					...
					<h3>문의글 수정하기</h3>
						...
						<form action="editQueryAction.do?queryNum=${list.queryNum}" class="form-horizontal"
							onsubmit="return frmCheck();" method="post" name="queryForm" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<label class="radio-inline"><input class="form-control" name="sellerId" id="sellerId"
								...
								<div class="form-group">
									<div class="col-sm-12" style="text-align:center;" >
										<input type="submit" class="btn btn-xs btn-info" value="수정하기" />
									</div>
								</div>
							</div>
