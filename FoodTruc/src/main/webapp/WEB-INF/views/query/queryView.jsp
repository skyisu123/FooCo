...
<body id="page-top" class="bg-light-gray index">
	...
	<div class="container" style="margin-top: 150px;">
				<div class="row">
					...
					<h3>
					<img src="../resources/bootstrap/img/about/letter.png"  style="width:40px; height:40px;" />
					&nbsp;&nbsp;&nbsp;					
					문의글 상세보기
					</h3>
					</div>
						<form action="sellerQuerySendAction.do" class="form-horizontal"
							...
							<div class="form-group">
								...
								<div class="form-group">
									...
									style="font-weight:bold;" for="memberId">사용자 아이디</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label"
									style="font-weight:bold;"  for="sellerId">푸드트럭 아이디</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										style="border-bottom:1px solid purple;
										font-weight:bold;"
											value="${list.queryTitle}"  readonly
											 type="text">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<textarea name="queryContent" readonly
										style="width:100%; height:200px; border:1px solid gray; border-radius:5px;"
										>${list.queryContent}</textarea>
									</div>
								</div>
								<c:if test="${list.queryRead ne 'N' }">
								<div class="form-group">
									<div class="col-sm-12" style="text-align:center;" >
										<input type="button" class="btn btn-xs"
										onclick="location.href='editQuery.do?queryNum=${list.queryNum}&listType=${listType }'"
										 value="수정하기" />
									</div>
								</div>
								</c:if>
							...
							<c:if test="${listType ne 'send' }">
								<div class="form-group">
									<div class="col-sm-12" style="text-align:center;" >
										...
										onclick="location.href='answerQuery.do?queryNum=${list.queryNum}'" value="답변하기" />
									</div>
								</div>
							</c:if>
							<c:if test="${listType eq 'send' }">
								<div class="form-group">
									<div class="col-sm-12" style="text-align:center;" >
										<input type="button" class="btn btn-warning"
										onclick="location.href='editQuery.do?queryNum=${list.queryNum}&listType=${listType }'"
